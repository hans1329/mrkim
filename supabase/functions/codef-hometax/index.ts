...
function getHometaxErrorMessage(code: string): string {
  const messages: Record<string, string> = {
    "CF-00000": "정상 처리되었습니다.",
    "CF-00007": "입력 정보를 다시 확인해주세요. 인증서 파일 또는 비밀번호가 올바르지 않습니다.",
    "CF-04000": "계정 등록에 실패했습니다. 인증서와 비밀번호를 다시 확인해주세요.",
    "CF-04012": "이미 등록된 계정입니다.",
    "CF-04020": "인증서 비밀번호가 올바르지 않습니다.",
  ...
  return messages[code] || `홈택스 연결 중 문제가 발생했습니다. (오류코드: ${code})`;
}
