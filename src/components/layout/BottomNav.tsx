...
export function BottomNav() {
  ...
  return (
    <nav className="flex-shrink-0 bg-white border-t border-border/30 shadow-[0_-2px_20px_rgba(0,0,0,0.08)]" style={{ borderRadius: '9999px 9999px 0 0', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
