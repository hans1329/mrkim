...
export function BottomNav() {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 z-50 mx-3 mb-2 rounded-full bg-white dark:bg-card border border-border/50 shadow-lg" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
