...
export function BottomNav() {
  ...
  return (
    <div className="absolute left-0 right-0 z-20 flex items-center justify-center pointer-events-none" style={{ bottom: '-13px', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
