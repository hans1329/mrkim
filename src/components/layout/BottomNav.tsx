...
export function BottomNav() {
  ...
  return (
    <nav className="flex-shrink-0 mx-3 mb-2 rounded-full bg-white border border-border/50 shadow-[0_-2px_20px_rgba(0,0,0,0.1)]" style={{ marginBottom: `max(0.75rem, env(safe-area-inset-bottom))` }}>
