...
export function BottomNav() {
  ...
  return (
    <nav className="flex-shrink-0 mx-2 bg-white shadow-[0_-2px_20px_rgba(0,0,0,0.08)]" style={{ borderRadius: '40px', marginBottom: 'calc(env(safe-area-inset-bottom, 0px) + 4px)' }}>
