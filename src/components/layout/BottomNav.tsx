...
export function BottomNav() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-20 flex items-center justify-center pointer-events-none" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)', paddingTop: '4px' }}>
