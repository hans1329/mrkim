...
export function BottomNav() {
  ...
  return (
    <nav className="flex-shrink-0 mx-3 rounded-full bg-white border border-border/50 shadow-[0_-2px_20px_rgba(0,0,0,0.1)]" style={{ marginBottom: 'env(safe-area-inset-bottom, 0px)' }}>
