    ...
    <div className="flex h-screen overflow-hidden justify-center bg-background lg:gap-8 lg:px-8">
      ...
      <div className="w-full h-full lg:w-[580px] xl:w-[640px] lg:flex-shrink-0">
        <div className="relative flex h-full max-w-xl flex-col shadow-2xl lg:max-w-none mx-auto overflow-hidden">
          <div className={`flex-1 overflow-auto ${stickyHeader ? "bg-gradient-to-br from-primary via-primary to-[hsl(230,70%,50%)]" : ""}`} id="app-scroll-container">
            ...
            {/* Main Content */}
            <main className={showBackButton ? "p-4 pb-24 overflow-x-hidden" : stickyHeader ? "pb-24 overflow-x-hidden relative -mt-[calc(env(safe-area-inset-top,0px)+60px)]" : "pb-24 overflow-x-hidden"}>
              {children}
            </main>
          </div>
