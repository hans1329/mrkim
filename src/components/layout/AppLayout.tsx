  ...
  return <div className="flex h-screen overflow-hidden justify-center bg-gradient-to-br from-primary/5 via-background to-secondary/10 lg:gap-8 lg:px-8">
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[560px] lg:flex-col lg:justify-center lg:relative">
        <div className="relative z-10 p-8 space-y-6">
          ...
          {/* 앱 다운로드 통합 박스 */}
          <div className="p-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl border border-primary/20 space-y-4">
            <p className="text-sm font-medium text-foreground">📲 앱 다운로드</p>
            
            <div className="flex items-center gap-4">
              {/* QR 코드 */}
              <div className="p-2 bg-background rounded-xl shadow-sm flex-shrink-0">
              ...
              <div className="flex flex-col gap-2">
                {/* App Store 버튼 */}
                <a href="#" className="inline-flex items-center gap-2 px-3 py-1.5 bg-foreground text-background rounded-lg hover:bg-foreground/90 transition-colors">
            ...
            <p className="text-xs text-muted-foreground">QR 스캔 또는 버튼 클릭으로 설치하세요</p>
          </div>
        </div>
      </div>
