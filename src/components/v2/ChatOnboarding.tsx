          ...
          onSubmit={async (payload) => {
            ...
            try {
              ...
              if (payload.service === "card") {
                ...
                const certFileBase64 = await fileToBase64(payload.cert_file);
                // v3: DER+KEY 원본을 그대로 전송 (PFX 합성 제거 → CF-04025 회피)
                ...
                if (payload.key_file) {
                  ntPayload.derFileBase64 = certFileBase64;
                  ntPayload.keyFileBase64 = await fileToBase64(payload.key_file);
                } else {
                  ntPayload.certFileBase64 = certFileBase64;
                }
