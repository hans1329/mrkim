...
export default function Transactions() {
  ...
  return (
    ...
    >
      <Tabs defaultValue="list" className="space-y-2.5 bg-card min-h-screen -mx-4 px-4 -mt-2 pb-4">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <div className="rounded-md bg-card border p-3 min-w-0">
              ...
              {isStatsLoading ? (
                ...
                <p className="text-base font-bold text-green-600 break-all leading-tight">{formatCurrency(stats?.totalIncome || 0)}</p>
              )}
            </div>
            <div className="rounded-md bg-card border p-3 min-w-0">
              ...
              <div className="overflow-hidden">
                <div className="p-0">
                  {visibleTransactions.map((transaction) => (
                    <div key={transaction.id} className="px-3 py-2.5 active:bg-muted/50 transition-colors">
