    ...
    <MainLayout title="비서들의 모임" showBackButton>
      {showSplash ? (
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
          <div 
            className="animate-bounce rounded-full overflow-hidden"
      ...
      <div className={cn("pb-32 animate-fade-in", isMobile ? "px-4 pt-4" : "max-w-2xl mx-auto")}>
        ...
        {/* 내 비서 초안 (승인 대기) */}
        <div className="mb-5">
          <p className="text-xs font-medium text-muted-foreground mb-2.5">📋 {josa(secretaryName, "이/가")} 글을 올리고 싶어 합니다!</p>
          {profileLoading ? (
