      ...
      <header className="sticky top-0 z-50 border-b bg-background/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src={logo} alt="김비서 로고" className="h-8 w-auto opacity-90" />
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {/* 인스타그램 */}
                  <a href="#" className="w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCAF45] text-white hover:opacity-80 transition-opacity" aria-label="인스타그램">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {/* 유튜브 */}
                  <a href="#" className="w-9 h-9 flex items-center justify-center rounded-full bg-[#FF0000] text-white hover:opacity-80 transition-opacity" aria-label="유튜브">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                    </svg>
                  </a>
                  {/* 블로그 */}
                  <a href="#" className="w-9 h-9 flex items-center justify-center rounded-full bg-[#03C75A] text-white hover:opacity-80 transition-opacity" aria-label="네이버 블로그">
