...
export default function Dashboard() {
  ...
  return (
    <MainLayout title={greeting} subtitle="오늘도 김비서가 도와드릴게요" stickyHeader={mobileStickyHeader}>
      ...
      {isMobile ? (
        <div>
          <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-[hsl(230,70%,50%)] px-5 pb-8 -mt-[calc(env(safe-area-inset-top)+60px)] pt-[calc(env(safe-area-inset-top)+60px)]">
            {/* 배경 데코 */}
